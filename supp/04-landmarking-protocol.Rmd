...
Results of the elliptical Fourier analysis (EFA) indicate that differences in Gahagan biface shape occur primarily near the base for each of the regions. Unlike the regional analysis, results for the analysis of mortuary context were not significant; however, there exists a possibility that the bifaces recovered from mortuary contexts may differ in shape along the midline or in cross-section. This study also includes an analysis of object symmetry and fluctuating asymmetry, where plan, profile, and cross-sections will be assessed.
...
The characteristic points and tangents developed for this landmarking protocol were inspired by the work of Birkhoff [-@RN11786], which has been gainfully employed within the context of both ceramic [@RN11801;@RN11782;@RN11716;@RN20697] and lithic analyses [@RN11783;@RN21001]. 
...
_The angle between the ref.pl.2 and ref.pl.3 was measured on each side of ref.pl.2, and the side with the lowest angle was kept on the right during the remainder of the landmarking process. LMs 02 and 03 were assigned following this calculation._
