...
Results of the elliptical Fourier analysis (EFA) indicate that Gahagan biface shapes differ by burial context, and that shape variation is not confined to a single part of the biface. Edge-based differences run from the tip to the base, and there are also a few instances where basal shape differs.
