...
The landmarking protocol developed for this project represents a substantial methodological advancement when contrasted with those protocols used in the previous studies of Gahagan biface morphology [@RN11783;@RN21001]. This protocol represents the continued evolution of a research programme concerned with the development of a rigourous and replicable three-dimensional landmarking workflow, which simultaneously takes into account the complex design components of individual bifaces. The second is the method of landmark placement, where reverse-engineering software---_Geomagic Design X (Build Version 2020.0.1 [Build Number: 30])_---was used to modify the previous configuration based upon specific design attributes, yielding a constellation of landmarks and semilandmarks applied using a suite of mathematically-defined criteria, which is outlined below. The result is a landmark configuration that articulates with specific morphological features that have demonstrated utility in wide-ranging studies of bifacial and projectile point morphology.
...
The goal of this effort was to increase the precision and rigour of the study by including the Z-dimension to capture those morphological characteristics associated with axial twisting, which are thought to have been introduced through the practice of bifacial bevelling. This landmarking protocol is the culmination of the iterative design process that began during the previous 2D [@RN11783] and 3D [@RN21001] geometric morphometric analyses. The cross-sections increase the coverage of semilandmarks across the mesh topology, providing for greater precision in the analysis of morphology for the whole object, and can be subset as a means of analysing specific features. For instance, might basal and blade cross sections express differing morphology? The evolution of this landmarking protocol represents a concerted effort to better comprehend the vagaries of morphological similarities and differences among Gahagan bifaces. While true that some landmarking protocols can be---and often are---recycled as new specimens are added, this particular research programme endeavours to achieve ever-greater accuracy and precision in each subsequent iteration.
