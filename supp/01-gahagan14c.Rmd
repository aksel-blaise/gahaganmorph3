...
Further information regarding the radiocarbon dates discussed below can be found in the text of the previous article [@RN21001], and the references cited below.
...
```{r chronmod2, echo=TRUE, eval=FALSE}
