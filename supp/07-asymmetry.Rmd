...
Within studies of biface morphology, an analysis of bilateral/object symmetry can yield useful insights related to _design intent_, given the assumption that the knapper's goal was to achieve a symmetrical shape. Within that framework, deviation from bilateral symmetry (fluctuating asymmetry) can serve as a useful measure of _morphological standardization_ in an analysis of morphological disparity. Both measures have utility in comparisons of contexts and sites, to include wide-ranging spatial and temporal applications.
